"""
Script to convert CSV files from the latest folder in .Claude Code/skills/fetchAPI/data
to parquet format and save them to .Claude Code/skills/migrate/data.
...
def main():
    ...
    # Define paths
    script_dir = Path(__file__).resolve().parent.parent.parent  # Go up to .Claude Code level
    source_base = script_dir / "skills" / "fetchAPI" / ".claude" / "skills" / "fetchAPI" / "data"
    output_base = script_dir / "migrate" / "data"
